...
# calcWindChillIndex(air_temp = float(input("Please put the air temperature here: ")), wind_speed = float(input("Please put the wind speed here: ")))
...
# wind_chill_index = calcWindChillIndex()
# print(wind_chill_index)




# from function import calcWindChillIndex
